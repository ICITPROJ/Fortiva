...
public static class BridgeSessionAuth
{
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            await writer.WriteLineAsync("GET".AsMemory(), linked.Token).ConfigureAwait(false);
            return await BridgeJson.ReadBoundedLineAsync(reader, linked.Token).ConfigureAwait(false);
        }
