# Code signing (Authenticode) — deferred for Personal
...
Uncomment or restore the **Sign published executables**, **Sign installers**, and **Verify Authenticode signatures** steps in `release.yml`.
